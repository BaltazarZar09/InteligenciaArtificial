...
function preload() {
    juego.load.image('background', 'assets/sprites/fondo_espacial.jpg');
    juego.load.spritesheet('nave', 'assets/sprites/nave_1.png', 90, 45);
    juego.load.image('menu', 'assets/game/menu.png');
    juego.load.image('pelota', 'assets/sprites/black_hole.gif',);
  }
